package com.beyondthecode.shared.domain

import androidx.lifecycle.LiveData
import androidx.lifecycle.MutableLiveData
import com.beyondthecode.shared.domain.internal.DefaultScheduler
import com.beyondthecode.shared.domain.internal.Scheduler
...
abstract class UseCase<in P, R>{
     ...
     * @param result the MutableLvieData where the result is posted to
     * */
