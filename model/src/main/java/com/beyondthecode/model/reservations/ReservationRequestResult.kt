...
data class ReservationRequestResult (
    ...
    enum class ReservationRequestStatus{
        ...
        /**The reservation requestwas denied because it was too close to the start of the event */
        RESERVE_DENIED_CUTOFF,

        /**The reservation was denied because it overlapped with another reservation or waitlist*/
        ...
        /**The cancellation request was denied because it was too close to the start of the event*/
